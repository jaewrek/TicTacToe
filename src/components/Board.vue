    ...
    <table class="center">
        <div v-if="newGame">
          ...
          Your turn
                ...
                <button v-if="moves == 9 || gameOver"
                        @click="restart"
                        class="restart playerCard">
                    Game Over. Restart?
                </button>
                <span v-if="!playerOneTurn && !gameOver" class="playerCard">
          Computer's turn
            ...
            <tr class="grid">
                <Cell name="0"
                      :markedStatus="cells[0]"></Cell>
                <Cell name="1"
                      :markedStatus="cells[1]"></Cell>
                <Cell name="2"
                      :markedStatus="cells[2]"></Cell>
            </tr>
            <tr class="grid">
                <Cell name="3"
                      :markedStatus="cells[3]"></Cell>
                <Cell name="4"
                      :markedStatus="cells[4]"></Cell>
                <Cell name="5"
                      :markedStatus="cells[5]"></Cell>
            </tr>
            <tr class="grid">
                <Cell name="6"
                      :markedStatus="cells[6]"></Cell>
                <Cell name="7"
                      :markedStatus="cells[7]"></Cell>
                <Cell name="8"
                      :markedStatus="cells[8]"></Cell>
            </tr>
            <tr class="score">
...
export default {
  ...
  data () {
    return {
      ...
      playerMark: '',
      computerMark: '',
      winningCombinations: [[0, 1, 2], [0, 4, 8], [0, 3, 6], [1, 4, 7], [2, 5, 8], [2, 4, 6], [3, 4, 5], [6, 7, 8]]
    }
  },
  created () {
